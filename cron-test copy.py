...
if __name__ == '__main__':
    ...
    call1 = multiprocessing.Process(name='call1', target=call1(flat_list))
    call2 = multiprocessing.Process(name='call2', target=call2(flat_list1))
...
print("This script took: {} minutes".format(float(end-bitflyer)))
print("This script took: {} minutes".format(float(end1-end)))
