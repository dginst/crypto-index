...
all_data['Pair'] = [element.replace('USDT_BCHSV', 'bsvusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_BCHSV', 'bsvusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_BCHABC', 'bchusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_BCHABC', 'bchusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_LTC', 'ltcusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_LTC', 'ltcusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_XRP', 'xrpusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_XRP', 'xrpusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_ZEC', 'zecusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_ZEC', 'zecusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_EOS', 'eosusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_EOS', 'eosusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_ETC', 'etcusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_ETC', 'etcusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_STR', 'xlmusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_STR', 'xlmusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_BTC', 'btcusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_BTC', 'btcusdt') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDC_ETH', 'ethusdc') for element in all_data['Pair']]
all_data['Pair'] = [element.replace('USDT_ETH', 'ethusdt') for element in all_data['Pair']]
