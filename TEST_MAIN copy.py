...
Exchanges = [ 'coinbase-pro', 'poloniex', 'bitstamp', 'gemini', 'bittrex', 'kraken'] #'kraken'
#############################################################################################################
    ...
    for exchange in Exchanges:
        ...
        if Exchange_Price.size == 0:
            ...
            if Ccy_Pair_Volume.size != 0:
                ...
                save = Exchange_Vol_DF.to_csv(r'C:/Users/mpich/Desktop/df'+exchange+'.csv')
                save2 = Exchange_Price_DF.to_csv(r'C:/Users/mpich/Desktop/dfprice'+exchange+'.csv')
